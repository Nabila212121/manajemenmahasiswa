            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-md w-50" id="kelas" placeholder="Masukkan Alamat" name="nama" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Tanggal Lahir</label>
                        <label for="tanggal_lahir">Tanggal Lahir:</label>
                        <input type="date" class="form-control w-50" id="tgllahir" placeholder="Masukkan tanggal lahir" name="jurusan" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="semester" class="form-label">Usia</label>
                        <input type="number" class="form-control w-50" id="usia" placeholder="Masukkan Usia" name="semester" autocomplete="off" required>
                    </div>
